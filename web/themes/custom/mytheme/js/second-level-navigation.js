...
((Drupal) => {
  const { isDesktopNav } = Drupal.mytheme;
  ...
  Drupal.mytheme.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.mytheme.isDesktopNav()) return;
  ...
  Drupal.mytheme.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.mytheme.areAnySubNavsOpen = areAnySubNavsOpen;
