...
((Drupal) => {
  ...
  Drupal.mytheme.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      "Drupal.mytheme.stickyHeaderState",
      JSON.stringify(item)
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem("Drupal.mytheme.stickyHeaderState");
      return false;
    }
    return item.value;
  }
