...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener("keyup", (e) => {
      if (e.key === "Escape") {
        if (props.mytheme.areAnySubNavsOpen()) {
          props.mytheme.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.mythemeNavigation = {
    attach(context) {
